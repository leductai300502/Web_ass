...
<body>
    ...
    if($_SERVER['REQUEST_METHOD'] === 'POST')
    {
        ...
        $update_New = $New ->update_New_class($tieude,$mota,$theloai,$image,$id); 
    }
    ?>
    ...
    <form action="" method="POST" enctype="multipart/form-data" class="flex flex-col">
                    ...
                    <div>
                        ...
                        <div class="flex flex-row">
                            ...
                            <textarea type="text" name="tieu_de" class="myTextarea" id=""><?php echo $result['Ten'] ?></textarea>
                            </div>
                            <div class="grow"></div>
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="flex flex-row">
                            <div class="border-2 border-black">
                                <textarea type="text" name="mo_ta" class="myTextarea" id=""><?php echo $result['Mo_Ta'] ?></textarea>
                            </div>
                            <div class="grow"></div>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-row">
                        <div class="grow"></div>
                        <div>
                            <button class="border-2 border-black bg-zinc-400 mt-4 rounded-xl p-4" type="submit">Change now</button>
                        </div>
                        <div class="grow"></div>
                    </div>
                </form>
