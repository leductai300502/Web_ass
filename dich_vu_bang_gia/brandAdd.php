        ...
        <div class="mx-auto flex flex-row w-96 p-4">
            <div class="grow p-8 border-2 border-slate-500 rounded-xl">
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <select class="w-60 border-2 border-black" name="danhmuc_id" id="" required>
                    ...
                    <input type="text" name="loaisanpham_ten" class="w-60 border-2 border-black" required><br>
        ...
        <div>
            <table class="mx-auto w-2/3 table-auto border-2 border-collapse border-slate-500 p-8">
                <tr>
                    ...
                    <th class="border border-slate-700 p-4">Loại sản phẩm ID</th>
                    <th class="border border-slate-700 p-4">Danh mục</th>
                    <th class="border border-slate-700 p-4">Loại sản phẩm</th>
                    <th class="border border-slate-700 p-4">Tùy chỉnh</th>
                </tr>
                <?php
                ...
                ?>
                    <tr>
                        ...
                        <th class="border border-slate-700 p-2"><?php echo $result['loaisanpham_id'] ?></th>
                        <th class="border border-slate-700 p-2"><?php echo $result['danhmuc_ten'] ?></th>
                        <th class="border border-slate-700 p-2"><?php echo $result['loaisanpham_ten'] ?></th>
                        <th class="border border-slate-700 p-2">
                            <div class="flex flex-col content-between">
                                <div class="flex p-2 justify-center bg-green-500 rounded-xl">
                                    <a href="brandedit.php?brand_id=<?php echo $result['loaisanpham_id'] ?>"><i class="fas fa-edit p-2"></i>Edit</a>
                                </div>
                                <div class="flex p-2 justify-center bg-red-500 rounded-xl">
                                    <a href="branddelete.php?brand_id=<?php echo $result['loaisanpham_id'] ?>"><i class="fas fa-minus-circle p-2"></i>Delete</a>
                                </div>
                            </div> 
